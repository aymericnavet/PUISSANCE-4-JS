(function($) {
	$.fn.puissance_4 = function(width, height, player1 , player2 , couleur1 , couleur2 , maxRound = 3) {
		...
		var arr = new Array(), player = 1, color = "yellow", win1 = 0, win2 = 0, roundWon = false, cancelCell;
		...
		$("#p4").before("<button id='replay' style='border-radius:5px; background-color:skyblue'>Rejouer</button>"+
						"<button id='cancel' style='border-radius:5px; background-color:skyblue'>Annuler</button>"+
						"<button id='reset' style='border-radius:5px; background-color:skyblue'>Reset le score</button>")
	...
	$(document).ready(function () {
		$("div").puissance_4(7,7,"test1", "test2", "#1C00FF", "#4BFF00");
	});